...
namespace Lab5.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var list = _context.Employee.Include(n => n.EmployeeRole).ThenInclude(n => n.Role);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                bool selected = false;
                if (_context.EmployeeRole.Any(n => n.EmployeeId == id && n.RoleId == role.Id))
                {
                    selected = true;
                }
        ...
        {
            var employeeRoleSelctions = _context.EmployeeRole.Where(n => n.EmployeeId == id).ToList();
            _context.EmployeeRole.RemoveRange(employeeRoleSelctions);
            var employee = await _context.Employee.FindAsync(id);
